...
| `colorName`        | The color of the button.                          | `Colors`                | `"PRIMARY"`            |
| `colorHex`         | The color of the button (hex).                    | `string`                | -                      |
| `contentColorName` | The color of the content of the button.           | `Colors`                | -                      |
...
| `fontSize`         | The font size of the button.                      | `PikasFontSize`         | `"EM-MEDIUM"`          |
...
| `boxShadow`        | The box shadow of the button.                     | `PikasShadow or 'none"` | `"ELEVATION_BOTTOM_1"` |
