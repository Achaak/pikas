...
| `validateButtonColorName` | Sets the color of the validate button          | `Colors`     | `"PRIMARY"` |
...
| `validateButtonColorName` | Sets the color of the validate button          | `Colors`     | `"SUCCESS"`        |
| `cancelButtonColorName`   | Sets the color of the cancel button            | `Colors`     | `"DANGER"`         |
| `validateButtonDisabled`  | Sets the disabled state of the validate button | `boolean`    | -                  |
...
| `validateButtonLabel`     | Sets the label of the validate button          | `string`     | `"Ok"`                         |
| `onValidated`             | Callback when the dialog is validated          | `() => void` | -                              |
| `validateButtonColorName` | Sets the color of the validate button          | `Colors`     | `"DANGER"`                     |
| `validateButtonDisabled`  | Sets the disabled state of the validate button | `boolean`    | -                              |
| `validateButtonLoading`   | Sets the loading state of the validate button  | `boolean`    | -                              |
