...
| `css`                 | Custom CSS of the dialog                           | `CustomDialogCSSType`     | -        |
| `width`               | Sets the width of the dialog                       | `string or number`        | `500`    |
| `height`              | Sets the height of the dialog                      | `string or number`        | -        |
| `padding`             | Sets the padding of the dialog                     | `CustomDialogPaddingType` | -        |
| `gap`                 | Sets the gap of the dialog                         | `CustomDialogGapType`     | -        |
