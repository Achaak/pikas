...
const Example: React.FC = () => {
  return (
    <Skeleton<PikasCSS> animation="pulse" width="100%" height={24} />
    <Skeleton<PikasCSS> animation="wave" width="100%" height={24} />
    <Skeleton<PikasCSS> animation={false} width="100%" height={24} />
  )
}
```
...
| `borderRadius` | The border radius of the skeleton. | `BorderRadius`      | `"sm"`    |
