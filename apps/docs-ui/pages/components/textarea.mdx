...
| `color`               | The color of the textarea.                 | `Colors`           | -                |
| `colorHex`            | The color hex of the textarea.             | `string`           | -                |
| `placeholderColor`    | The placeholder color of the textarea.     | `Colors`           | -                |
| `placeholderColorHex` | The placeholder color hex of the textarea. | `string`           | -                |
| `borderColor`         | The border color of the textarea.          | `Colors`           | `"TRANSPARENT"`  |
