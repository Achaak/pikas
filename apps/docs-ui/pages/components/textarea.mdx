...
| `colorName`               | The color of the textarea.                 | `Colors`           | -                |
| `colorHex`            | The color hex of the textarea.             | `string`           | -                |
| `placeholderColorName`    | The placeholder color of the textarea.     | `Colors`           | -                |
| `placeholderColorHex` | The placeholder color hex of the textarea. | `string`           | -                |
| `borderColorName`         | The border color of the textarea.          | `Colors`           | `"TRANSPARENT"`  |
