...
| `placeholderColorName` | The placeholder color of the textfield.     | `PikasColors`                                | `"BLACK_LIGHT"`     |
...
| `backgroundColorName`  | The background color of the textfield.      | `PikasColors`                                | `"GRAY_LIGHTEST_1"` |
