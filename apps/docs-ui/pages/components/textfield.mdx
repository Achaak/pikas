...
| `color`               | The color of the textfield.                 | `Colors`                                           | -                   |
| `colorHex`            | The color hex of the textfield.             | `string`                                           | -                   |
| `placeholderColor`    | The placeholder color of the textfield.     | `Colors`                                           | -                   |
| `placeholderColorHex` | The placeholder color hex of the textfield. | `string`                                           | -                   |
| `borderColor`         | The border color of the textfield.          | `Colors`                                           | `"TRANSPARENT"`     |
| `borderColorHex`      | The border color hex of the textfield.      | `string`                                           | -                   |
| `borderWidth`         | The border width of the textfield.          | `number`                                           | `0`                 |
| `backgroundColor`     | The background color of the textfield.      | `Colors`                                           | `"GRAY_LIGHTEST_1"` |
...
| `leftIconColor`       | The left icon color of the textfield.       | `Colors`                                           | -                   |
| `leftIconColorHex`    | The left icon color hex of the textfield.   | `string`                                           | -                   |
| `rightIconColor`      | The right icon color of the textfield.      | `Colors`                                           | -                   |
