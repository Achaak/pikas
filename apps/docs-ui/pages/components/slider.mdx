...
| `thumbBorderColorNameHover` | The color of the thumb border on hover.                         | `PikasColors`               | `"GRAY_LIGHTER"` |
...
| `trackColorName`            | The color of the track.                                         | `PikasColors`               | `"GRAY_LIGHTER"` |
...
[Edit this page on GitHub](https://github.com/Achaak/pikas/blob/main/apps/docs-ui/pages/components/slider.mdx)
