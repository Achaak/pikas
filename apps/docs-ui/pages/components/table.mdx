...
| :------------- | :------------------------------------------ | :--------------------- | :---------- |
| `variant`      | The variant of the table                    | `TableVariantType`     | `'default'` |
...
| `selection`    | The selection of the table                  | `TableSelectionType`   | -           |
| `sorting`      | The sorting of the table                    | `TableSortingType`     | -           |
| `columns`      | The columns of the table                    | `ColumnDef<T>[]`       | -           |
| `css`          | The css of the table                        | `TableCSSTypes`        | -           |
| `padding`      | The padding of the table                    | `TablePaddingType`     | -           |
