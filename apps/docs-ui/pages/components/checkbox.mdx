...
| `bgColor`        | The background color of the checkbox.              | `Colors`                     | `"WHITE"`        |
| `bgColorChecked` | The background color of the checkbox when checked. | `Colors`                     | `"PRIMARY"`      |
| `textError`      | The error text of the checkbox.                    | `string`                     | -                |
| `boxShadow`      | The box shadow of the checkbox.                    | `PikasShadow` or `"none"`    | `"DIMINUTION_1"` |
| `borderColor`    | The border color of the checkbox.                  | `Colors`                     | -                |
