...
| `bgColorName`        | The background color of the checkbox.              | `PikasColors`                | `"WHITE"`        |
| `bgColorNameChecked` | The background color of the checkbox when checked. | `PikasColors`                | `"PRIMARY"`      |
