...
| :-------------- | :---------------------------------------- | :--------------------------- | :------ |
| `as`            | The HTML tag to use for the root element. | `TitleComponentType`         | -       |
| `variant`       | The variant to use.                       | `TitleVariantType`           | -       |
| `textTransform` | The text transform to use.                | `TextTransformComponentType` | -       |
| `css`           | The css to use.                           | `TitleCSSType`               | -       |
